...
public class WorkerService {
    ...
    public WorkerService(DockerService dockerService, WorkerRepository workerRepository, WorkerStatsRepository workerStatsRepository) {
    ...
    public WorkerStatProjection getWorkerStat(String id) throws NoSuchElementException, WorkerStatNotAvailableException {
        ...
        String current_timestamp = Timestamp.valueOf(current_time).toString();

        WorkerStatProjection stat = workerStatsRepository.findByWorkerId(id, current_timestamp);
